        ...
        <main className="page-shell">
            ...
            <div className="section-shell grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="space-y-6 lg:col-span-1">
                    <div className="paper-card p-7 rounded">
                ...
                <div className="paper-card p-8 md:p-12 rounded lg:col-span-2">
                    <h2 className="text-2xl text-gray-900 mb-8">Send a Message</h2>
                    <form className="space-y-6" onSubmit={onSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    value={form.fullName}
                                    onChange={onChange}
                                    className="w-full bg-white border border-gray-300 p-3 rounded focus:bg-white focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                value={form.message}
                                onChange={onChange}
                                className="w-full bg-white border border-gray-300 p-3 rounded focus:bg-white focus:ring-1 focus:ring-blue-600 focus:border-blue-600 outline-none resize-none"
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full md:w-auto bg-blue-700 text-white px-10 py-3 rounded border border-blue-800 font-semibold hover:bg-blue-800 disabled:opacity-60"
                        >
